...
public class MainActivity extends Activity {
    ...
    private final String[] PERMISSIONS = {"miui.permission.WRITE_STEPS", "miui.permission.READ_STEPS"};
    private final String DEFAULT_ORDER = "_id ASC";
    ...
    private void getTodayStep() {
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    Cursor cursor = getContentResolver().query(STEP_URI, QUERY_FILED, null, null, DEFAULT_ORDER);
    ...
    public void startStepAdd(View view) {
        try {
            ...
            e.printStackTrace();
            Toast.makeText(this, getString(R.string.toast_add_steps_failed) + e.toString(), Toast.LENGTH_SHORT).show();
        }
    }
